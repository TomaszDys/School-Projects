     ...
     <?php 	$social_title = get_theme_mod('social_title');
        ...
        <div class="copyright-wrapper">
        	<div class="container">            
               ...
               <?php esc_attr_e('&copy; 2016','interior-lite');?> <?php bloginfo('name'); ?>. <?php esc_attr_e('All Rights Reserved', 'interior-lite');?><br/><?php printf('<a class="freelink" href="'.esc_url(SKT_FREE_THEME_URL).'" rel="nofollow" target="_blank">SKT Interior Lite Theme</a>' ); ?>
            </div>          
        </div>
    </div>
<?php wp_footer(); ?>
